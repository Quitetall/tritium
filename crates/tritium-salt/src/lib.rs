...
pub use frontier_v3::{
    ...
    FrontierArtifactManifest, FrontierCompatibilityError, FrontierObjectiveDirection,
    FrontierObjectiveSpec, FrontierObjectiveValue, FrontierOrdering, FrontierParetoCandidate,
    FrontierParetoReceipt, FrontierPlanError, FrontierProfile, FrontierProfileCatalog,
    FrontierProfileId, FrontierSelection, FrontierSolver, FrontierSolverError, FrontierStage,
    FrontierStageOutcome, FrontierStageReceipt, FrontierTensorArtifact, ResourceDimension,
    ResourceVector, ResourceViolation, SolverDescriptor, SolverFamily, SolverId, SolverRegistry,
    SolverRequest, SolverTrust, TensorRepresentation, read_salt_v2_frontier_artifact,
};
pub use pipeline::{
