...
pub use model::{
    ...
    PackedTernaryMatrix, Qwen35Config, Qwen35LayerType, Qwen35MtpDecoder, Qwen35MtpModel,
    ...
    encode_external_causal_lm, encode_external_qwen_causal_lm, encode_external_qwen35_bundle,
