...
pub use model::{
    ...
    VerifiedExternalOnnxModel, VerifiedExternalOnnxModelV2, VerifiedExternalQwen35Bundle,
    VerifiedOnnxArtifactIdentityV2, VerifiedQwen35OnnxAncestryV1, diagnose_unsupported_graph,
    encode_causal_lm, encode_external_causal_lm, encode_external_qwen_causal_lm,
    encode_external_qwen35_bundle, encode_external_qwen35_bundle_with_ancestry,
