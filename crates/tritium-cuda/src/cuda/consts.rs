...
/// The balanced-ternary ladder fitter — `s_p = s0*3^-p`, one anchor per group instead of T
/// scales, and O(T) per weight instead of a per-plane residual pass.
pub(super) const KERNEL_NAME_SALT_QUANTIZE_GROUPED_GEOMETRIC: &str =
    "salt_quantize_forward_grouped_geometric";
...
pub(super) const KERNEL_NAME_TOPK_KD_BWD: &str = "topk_kd_backward";
...
pub(super) const KERNEL_NAME_TOPK_KD_FWD: &str = "topk_kd_forward";
...
pub(super) const KERNEL_NAME_HESTIA_FWD: &str = "hestia_relax_forward";
pub(super) const KERNEL_NAME_HESTIA_BWD_WEIGHT: &str = "hestia_relax_backward_w";
pub(super) const KERNEL_NAME_HESTIA_BWD_TAU: &str = "hestia_relax_backward_tau";
pub(super) const KERNEL_NAME_HESTIA_BWD_TAU_PARTIAL: &str = "hestia_relax_backward_tau_partial";
pub(super) const KERNEL_NAME_HESTIA_BWD_TAU_FINALIZE: &str = "hestia_relax_backward_tau_finalize";
...
pub(super) const KERNEL_NAME_MUON_STEP: &str = "muon_step";
pub(super) const KERNEL_NAME_CONV1D_FWD: &str = "conv1d_forward_portable";
