...
const KERNEL_NAME_KV_APPEND_TREE: &str = "kv_append_tree_g";
const KERNEL_NAME_ARGMAX_PARTIAL: &str = "argmax_rows_partial_f32";
const KERNEL_NAME_ARGMAX_COMBINE: &str = "argmax_rows_combine_f32";
/// Keep in sync with `ARGMAX_CHUNKS` in decode.cu.
const ARGMAX_CHUNKS: usize = 16;
const KERNEL_NAME_ATTN_TREE_SCORES_CTRL: &str = "gqa_attention_tree_scores_ctrl_g";
const KERNEL_NAME_ATTN_TREE_REDUCE_CTRL: &str = "gqa_attention_tree_reduce_ctrl_g";
...
struct BatchRawKernels {
    ...
    kv_append_tree: sys::CUfunction,
    attn_tree_scores_ctrl: sys::CUfunction,
    attn_tree_reduce_ctrl: sys::CUfunction,
}
