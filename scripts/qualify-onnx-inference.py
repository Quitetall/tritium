...
def assemble(
    ...
    *,
    ...
    skeleton = {
        "run_id": run_id, "model_artifact_id": model_artifact_id,
        "wheel": artifact_record(wheel), "artifact": artifact_record(onnx),
    }
    ...
    receipt: dict[str, Any] = {
        ...
        "wheel": skeleton["wheel"], "artifact": skeleton["artifact"],
        "model_artifact_id": model_artifact_id,
        **derived,
        "trace": {
            "file": retained.name, "bytes": retained.stat().st_size,
