...
| [0053](./0053-zoo-community-release.md) | Guides, governance/community, three-tier zoo, independent reproduction and release | 0043 + 0045–0052 | all ADR 0033 boxes green; local signed RC, authorized activation, post-publish smoke |

Plans 0050 and 0051 are active. Plans 0052 and 0053 are frozen, executable work
orders whose implementation has not started.
