...
The Slice 2 tracer corpus now carries 50 cases across 19 of 35 operations. In
...
`graph.causal_mask`, and `loss.softmax_cross_entropy` forward/VJP semantics, plus `graph.transpose`, repeated
...
This is incremental evidence, not Slice 2 closure: the remaining 16 operations
