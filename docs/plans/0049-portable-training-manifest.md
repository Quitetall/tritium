...
covers 33 vectors across detach, constant scale, add, multiply, ReLU2, SiLU,
RMSNorm, causal masking, row softmax, and all four lifecycle operations. Pointwise tensor work executes through resident WGSL
