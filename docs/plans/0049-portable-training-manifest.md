...
covers 27 vectors across detach, constant scale, add, multiply, ReLU2, SiLU,
causal masking, and all four lifecycle operations. Pointwise tensor work executes through resident WGSL
