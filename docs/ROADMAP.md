...
| 0049 | `docs/plans/0049-portable-training-manifest.md` | Frozen language-neutral training operation registry, semantic vectors, fallible backend seam, and native/constrained backend receipts | v1.1 / ADR 0033; plan 0044 | **in progress** — registry, 114-case corpus, CPU 35/35, actual wasmtime 35/35, and actual RTX 4090 CUDA 35/35 complete; native wgpu on the RTX 4090 covers 34/35 operations and 106/114 vectors; ROCm, Metal, wgpu attention, MCU, and admitted receipt tables remain open | wgpu attention → ROCm/Metal → MCU → receipts |
