...
| 0047 | `docs/plans/0047-huggingface-qat-ptq-facade.md` | Hugging Face QAT/Trainer/PTQ/export/reload facade | v1.1 / ADR 0033 | **in progress** — QAT/HF state, expert Qwen PTQ-master binding, exact physical nested allocation, and Rust selected-prefix package production landed; one-call raw-calibration PTQ, packaged `QuantizationResult`, export and load remain open | 0046 semantic gate |
