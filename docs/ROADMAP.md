...
| 0049 | `docs/plans/0049-portable-training-manifest.md` | Frozen language-neutral training operation registry, semantic vectors, fallible backend seam, and native/constrained backend receipts | v1.1 / ADR 0033; plan 0044 | **in progress** — registry, 114-case corpus, CPU 35/35 and actual wasmtime 35/35 complete; actual RTX 4090 CUDA covers 19/35; ROCm, Metal, native wgpu, MCU, remaining CUDA and admitted receipt tables remain open | CUDA completion → ROCm/Metal/wgpu → MCU → receipts |
