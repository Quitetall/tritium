...
| 0050 | `docs/plans/0050-web-training-session.md` | Strict-TypeScript compiled training session, deterministic WASM fallback, complete-manifest WebGPU, real-browser receipts and local npm archive | v1.1 / ADR 0033; plan 0049 frozen schema | **in progress** — work order and reproducible strict-TypeScript local-RC package complete; WASM controller, session, WebGPU and browser receipts open | WASM controller → session → WebGPU → browser receipts → archive/tutorial |
