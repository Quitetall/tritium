...
| **v1.1 Full Public Release — ternary research platform** | **0033** | **Proposed; implementation in progress.** PyTorch/Hugging Face first-class differentiable workflow, SOTA estimator/PTQ/refinement catalog, portable backend and browser training core, full packaging/deployment/community surface, three-tier audited model zoo, and plan-0043 flagship proof. Native first-class training and trainable ONNX are binding later-1.x work. Active execution: plan 0044. |
...
| 0044 | `docs/plans/0044-v11-full-public-release.md` | **ACTIVE RELEASE WORK ORDER — Tritium v1.1 full public platform.** Shared schemas; PyTorch/HF autograd and zero-copy ops; estimator/PTQ/refinement facade; portable/browser training; ONNX inference; packages; production deployment/observability; governance/docs; audited zoo; release reproduction | ADR 0033; parallel dependency on plan 0043 | **in progress** (decision and master work order drafted; child implementation plans 0045–0053 open) | 0045 schemas/reference → 0046 Torch ops → parallel 0047/0048/0049 → 0050–0052 → 0053 release |
